...
track1 = album.tracks.create({ :title => 'The Gift Be', :file => File.open('db/seeds/audio/track/1313946157.mp3'), :artist => 'The Loot' })
track2 = album.tracks.create({ :title => 'Come Clean', :file => File.open('db/seeds/audio/track/1313946195.mp3'), :artist => 'The Loot' })
