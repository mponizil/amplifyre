...
track1 = album.tracks.create({ :title => 'The Gift Be', :file => 'uploads/track/file/1/1313946157.mp3', :artist => 'The Loot' })
track2 = album.tracks.create({ :title => 'Come Clean', :file => 'uploads/track/file/2/1313946195.mp3', :artist => 'The Loot' })
