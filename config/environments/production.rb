Amplifyre::Application.configure do
  ...
  config.consider_all_requests_local       = true # DEV MODE
  config.action_controller.perform_caching = false # DEV MODE
  ...
  config.action_mailer.default_url_options = { :host => 'amplifyre.com' }
end
